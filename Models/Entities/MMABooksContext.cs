...
public partial class MMABooksContext : DbContext
{
    ...
    {
      optionsBuilder.UseSqlServer($@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename='\\Mac\Home\Documents\C# App dev\ConsoleApp2\MMABooks.mdf';Integrated Security=True");
    }
